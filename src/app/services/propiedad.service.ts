...
export class PropiedadService {
  ...
  listQuery6(startDate: Date, endDate: Date): Observable<Query6dto[]> {
    ...
    const url = `https://tp-nexthouse.onrender.com/NextHouse/PropiedadQuery6/${formattedstartDate}/${formattedendDate}`;
    return this.http.get<Query6dto[]>(url);
  }

  listQuery7(ciudad: string): Observable<Query7dto[]> {
    const url = `https://tp-nexthouse.onrender.com/NextHouse/PropiedadQuery7/${ciudad}`;
